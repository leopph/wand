...
public:
  [[nodiscard]] WANDAPI
  auto AddDxilLibrary() -> CD3DX12_DXIL_LIBRARY_SUBOBJECT&;

  [[nodiscard]] WANDAPI
  auto AddHitGroup() -> CD3DX12_HIT_GROUP_SUBOBJECT&;

  [[nodiscard]] WANDAPI
  auto AddShaderConfig() -> CD3DX12_RAYTRACING_SHADER_CONFIG_SUBOBJECT&;

  [[nodiscard]] WANDAPI
  auto AddPipelineConfig() -> CD3DX12_RAYTRACING_PIPELINE_CONFIG_SUBOBJECT&;
