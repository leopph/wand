...
public:
  ...
  WANDAPI
  auto DispatchRays(D3D12_DISPATCH_RAYS_DESC const& desc) const -> void;
...
private:
  ...
  CommandList(Microsoft::WRL::ComPtr<ID3D12CommandAllocator> allocator,
              Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList7> cmd_list, detail::DescriptorHeap const* dsv_heap,
              detail::DescriptorHeap const* rtv_heap, detail::DescriptorHeap const* res_desc_heap,
              detail::DescriptorHeap const* sampler_heap, detail::RootSignatureCache* root_signatures);
  ...
  detail::PipelineResourceStateTracker local_resource_states_;
  std::vector<details::PendingBarrier> pending_barriers_;
  detail::DescriptorHeap const* dsv_heap_;
  detail::DescriptorHeap const* rtv_heap_;
  detail::DescriptorHeap const* res_desc_heap_;
  detail::DescriptorHeap const* sampler_heap_;
